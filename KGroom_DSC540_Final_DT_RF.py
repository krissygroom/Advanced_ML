...
##Read in as dataframe for visualization of features below
dataset = pd.read_csv('movies_clean_norm.csv')
...
#############################################################################
#
# Function to use for visualizing Decision Tree
#############################################################################
...
if binning==0 and cross_val==0:
    ...
    ## Decision Tree Visualization: found at https://www.kaggle.com/willkoehrsen/visualize-a-decision-tree-w-python-scikit-learn
    
    export_graphviz(rgr, out_file='tree.dot',  
    ...
    ##### followed https://stackoverflow.com/questions/44101458/random-forest-feature-importance-chart-using-python
    feat_importances = pd.Series(rgr.feature_importances_, index=dataset.columns[1:])
